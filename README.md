**TRANSFORMER DERİN ÖĞRENME MODELİ İLE YAMAÇ PARAŞÜTÜ UÇUŞ KAYITLARININ ANALİZİ VE PERFORMANS DEĞERLENDİRMESİ**
...
3.1.1. IGC Dosya Formatı

3.1.2. IGC Dosyasından Verilerin Alınması

3.1.3. Uçuş Kayıtları İçin Hava Durumu Verilerinin Alınması

3.2. Verilerin Hazırlanması

3.3. Verilerin Temizlenmesi

4\. Bulgular

4.1. Makine Öğrenmesi Modellerinin Orange Uygulaması ile Ön Değerlendirmesi

4.2. Makine Öğrenmesi Modellerinin Sklearn ve Tensorflow Python Kütüphaneleri ile Değerlendirilmesi

4.3. Makine Öğrenmesi LSTM, RNN, CNN ve Transformer Derin Öğrenme Modellerinin Değerlendirilmesi

4.4. Transformer Derin Öğrenme Modelinin Eğitimi

4.5. Yamaç Paraşütü Uçuşunun Analiz Edilmesi ve Skorlanması
...
Şekil 1.  “IGC\_file\_parse.py” Python Modülü (Kısmi Görünümü)
...
Şekil 2.  “weather\_data.py” Python Modülü (Kısmi Görünümü)
...
Şekil 3.  Leonardo Pilot Uçuş İstatistiği
...
Tablo 4.  Aykırı (Outlier) Gözlem Görülen Veriler
...
Şekil 4.  Orange Uygulaması Akış Şeması
...
Şekil 6.  Orange Uygulaması “Test and Score” Widget Çıktısı
...
Tablo 6.  Modellerin Karşılaştırılması
...
Şekil 7.  Makine Öğrenmesi Modellerinin Karşılaştırılması
...
Şekil 8.  Makine Öğrenmesi Modellerinin Tahmin Hata Dağılımları
...
Şekil 10.  Derin Öğrenme Modellerinin MAE ve RMSE Performansı
...
Şekil 11.  Derin Öğrenme Modellerinin Hata Performansı
...
Şekil 12.  Transformer Derin Öğrenme Modelinin Parametreleri

![](./proje_images/image-031.png)

Şekil 13.  Transformer Derin Öğrenme Modelinin Katman Bilgileri
...
Şekil 14.  Transformer Derin Öğrenme Modelinin Eğitim Eğrileri ve Hata Performansı
...
Şekil 15.  Performans Skorlaması
